...
## Folder Structure 
This is a project eas generated using Express Application
Generator. See [here] (https://expressjs.com/en/starter/generator.html)
for help. 

\components folder contains the bulk of the Feed generation code
